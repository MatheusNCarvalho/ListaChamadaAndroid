...
/**
 * Created by Brunno on 10/11/17.
 */

public class ChamadaALunoAdapter extends ArrayAdapter<Alunos> {
    private ArrayList<Alunos> aluno;
    private Context context;
    public ChamadaALunoAdapter( Context context, ArrayList<Alunos> objects) {
